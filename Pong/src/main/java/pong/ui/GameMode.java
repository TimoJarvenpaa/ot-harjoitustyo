...
public class GameMode {
    ...
    /**
     * Vaihtaa parametrina annetun sovellusikkunan näkymän pelimuodon
     * valitsemisesta vastaavaan näkymään.
     *
     ...
     * poistumista varten
     * @param score PlayerNames-näkymässä syötetyt pelaajien nimet sisältävä
     * Score-olio, joka välitetään eteenpäin PongUI-luokalle
     */
